...
```
Le schéma parent des requêtes et mutations se trouve [à cet endroit](https://github.com/TsWin/pronote-api/blob/master/src/server/schemas/parent.graphql)

Le schéma élèves des requêtes et mutations se trouve [à cet endroit](https://github.com/TsWin/pronote-api/blob/master/src/server/schemas/student.graphql)

Le schéma commun des requêtes et mutations se trouve [à cet endroit](https://github.com/TsWin/pronote-api/blob/master/src/server/schemas/common.graphql) 
